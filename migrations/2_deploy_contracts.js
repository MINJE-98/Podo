...
module.exports = async function(deployer) {
  ...
  await deployer.deploy(Campaign, Podo.address, Ballot.address, Group.address, {from: admin});
  await deployer.deploy(Governor, Podo.address, Ballot.address, Group.address, Campaign.address, {from: admin});
};
